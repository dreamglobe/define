...
angular
    ...
    .constant('authUrl', 'http://karmaware.mine.nu:9001/login')
    .constant('logoutUrl', 'http://karmaware.mine.nu:9001/logout')
    .constant('wsBroker', 'http://karmaware.mine.nu:9001/crossgate')
